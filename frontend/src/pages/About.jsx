...
const About = () => {
  const { user } = useAuth();
    return (<div className="min-h-screen flex flex-col bg-gradient-to-r from-blue-50 to-indigo-50 text-gray-800">
      <HomeNavbar />
      {/* Hero Section */}
      <section className="flex flex-col md:flex-row items-center justify-center py-12 px-6 md:px-12 lg:px-24">
        <div className="md:w-1/2 space-y-6">
          <h1 className="text-4xl md:text-5xl font-extrabold text-cyan-300">About Our Employee Management System</h1>
      ...
      {/* About EMS */}
      <section className="bg-white/10 backdrop-blur-lg rounded-2xl mx-6 md:mx-12 lg:mx-24 p-8 mb-8">
        <h2 className="text-3xl font-semibold text-cyan-300 mb-4">About EMS</h2>
      ...
      <section className="mx-6 md:mx-12 lg:mx-24 mb-12">
        <h2 className="text-3xl font-semibold text-cyan-300 mb-6 text-center">What We Provide</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={item.title}
              className="bg-white/10 backdrop-blur-md rounded-xl p-6 shadow-lg hover:shadow-2xl transition-shadow"
            >
      ...
      {/* Why Choose EMS */}
      <section className="bg-white/10 backdrop-blur-lg rounded-2xl mx-6 md:mx-12 lg:mx-24 p-8 mb-12">
        <h2 className="text-3xl font-semibold text-cyan-300 mb-4 text-center">Why Choose EMS</h2>
      ...
      {/* How It Works */}
      <section className="mx-6 md:mx-12 lg:mx-24 mb-12">
        <h2 className="text-3xl font-semibold text-cyan-300 mb-6 text-center">How It Works</h2>
        <div className="flex flex-col md:flex-row justify-center gap-8">
          {[
            ...
            <div key={item.step} className="flex-1 bg-white/10 backdrop-blur-md rounded-xl p-6 text-center">
              <div className="text-4xl font-bold text-cyan-300 mb-2">{item.step}</div>
              <h3 className="text-xl font-semibold text-cyan-200 mb-2">{item.title}</h3>
              <p className="text-gray-300 text-sm">{item.desc}</p>
            </div>
          ))}
        </div>
      ...
      {/* Roles */}
      <section className="mx-6 md:mx-12 lg:mx-24 mb-12">
        <h2 className="text-3xl font-semibold text-cyan-300 mb-6 text-center">Roles</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6">
            <h3 className="text-2xl font-bold text-cyan-200 mb-2">Admin</h3>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6">
            <h3 className="text-2xl font-bold text-cyan-200 mb-2">Employee</h3>
            <ul className="list-disc list-inside text-gray-200 space-y-1">
      ...
      {/* Technology */}
      <section className="bg-white/10 backdrop-blur-lg rounded-2xl mx-6 md:mx-12 lg:mx-24 p-8 mb-12">
        <h2 className="text-3xl font-semibold text-cyan-300 mb-4 text-center">Built With</h2>
      ...
      {/* Call To Action */}
      <section className="flex flex-col items-center py-12 bg-white/5 backdrop-blur-md rounded-2xl mx-6 md:mx-12 lg:mx-24 mb-12">
        <h2 className="text-3xl font-semibold text-cyan-300 mb-4 text-center">Ready to simplify employee management?</h2>
        <Link
          to="/login"
          className="mt-4 px-8 py-3 bg-cyan-600 hover:bg-cyan-700 rounded-md text-white font-medium transition-colors"
        >
          Get Started / Login
        </Link>
      </section>
