    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-pink-50 via-white to-pink-100 text-gray-800">
      ...
      <section className="flex flex-col md:flex-row items-center justify-center py-12 px-6 md:px-12 lg:px-24">
        <div className="md:w-1/2 space-y-6">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800">
            About Our WorkSphere
          </h1>
          <p className="text-lg md:text-xl text-gray-800">
            WorkSphere helps organizations Manage your employee activities
            efficiently with a centralized and easy‑to‑use WorkSphere platform.
          </p>
        </div>
      ...
      <section className="bg-[#fdf5f6] backdrop-blur-lg rounded-2xl border border-pink-200 shadow-md mx-6 md:mx-12 lg:mx-24 p-8 mb-8">
        ...
        <p className="text-gray-800 leading-relaxed mb-4">
          An efficient WorkSphere designed to simplify employee records,
          attendance, leaves, departments and salary management in one
          ...
          {[
            {
              ...
              desc: "Add, edit, view employee profiles and details.",
            },
            {
              title: "Attendance Management",
              desc: "Track daily check‑ins, check‑outs and generate reports.",
            },
            {
              title: "Leave Management",
              desc: "Submit, approve and monitor leave requests.",
            },
            {
              title: "Salary Management",
              desc: "Calculate payroll, generate payslips and tax reports.",
            },
            {
              title: "Department Management",
              desc: "Organise employees into departments and teams.",
            },
            {
              title: "Role‑Based Access",
              desc: "Secure permissions for admins and employees.",
            },
          ].map((item) => (
            <div
              key={item.title}
      ...
      <section className="mx-6 md:mx-12 lg:mx-24 mb-12">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8">
          {[
            {
              step: "1",
              title: "Admin manages employees & departments",
              desc: "Create, edit and organise staff information.",
            },
            {
              step: "2",
              title: "Employees manage their profile",
              desc: "Mark attendance, view salary and request leaves.",
            },
            {
              step: "3",
              title: "Admin reviews activities",
              desc: "Approve leaves, monitor attendance and run payroll.",
            },
          ].map((item) => (
            <div
              key={item.step}
              className="flex-1 bg-[#fdf5f6]/10 backdrop-blur-md rounded-xl p-6 text-center"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-[#fdf5f6]/10 backdrop-blur-md rounded-xl border border-pink-200 p-6">
            ...
            <ul className="list-disc list-inside text-gray-800 space-y-1">
              <li>
                Manage employees, departments, attendance, leaves and salary.
              </li>
      ...
      {!user && (
        <section className="flex flex-col items-center py-12 bg-[#fdf5f6] backdrop-blur-md rounded-2xl border border-pink-200 shadow-md mx-6 md:mx-12 lg:mx-24 mb-12">
          ...
          <Link
            to="/login"
            className="mt-4 px-8 py-3 bg-pink-500 hover:bg-pink-600 rounded-md text-white font-medium transition-colors shadow-md hover:shadow-lg"
          >
            Get Started / Login
          </Link>
        </section>
